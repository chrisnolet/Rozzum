      ...
      <main className="flex grow flex-col">
        ...
        <section className="w-full pt-16 sm:pt-24">
          <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
            {displayMessage && (
              <div className="mx-auto max-w-lg overflow-hidden rounded-2xl border border-blue-600 bg-blue-50 p-6 text-center break-words shadow-lg">
                <h3 className="text-lg font-medium whitespace-pre-wrap text-blue-600">{displayMessage}</h3>
              </div>
            )}

            {errorMessage && (
              <div className="mx-auto flex max-w-lg overflow-hidden rounded-2xl border border-red-600 bg-red-50 break-words shadow-lg">
